...
test('ToRawFixed(9.99, 0, 1)', () => {
  expect(ToRawFixed(new Decimal(9.99), 0, 0, 1, 1, 'half-infinity')).toEqual({
    formattedString: '10',
...
test('ToRawFixed(1e41, 0, 3)', () => {
  expect(ToRawFixed(new Decimal(1e41), 0, 0, 3, 1, 'half-infinity')).toEqual({
...
test('ToRawFixed(1e-10, 1, 21)', () => {
  expect(ToRawFixed(new Decimal(1e-10), 0, 1, 21, 1, 'half-infinity')).toEqual({
...
test('Rounding: ToRawFixed(123.445, 0, 2)', () => {
  expect(ToRawFixed(new Decimal(123.445), 0, 0, 2, 1, 'half-infinity')).toEqual(
    {
...
it('ToRawFixed(1.2344501e+34, 1, 3)', () => {
  expect(
    ToRawFixed(new Decimal(1.2344501e34), 0, 1, 3, 1, 'half-infinity')
  ).toEqual({
...
it('ToRawFixed(1,234,567,891,234,567.35, 2, 2)', () => {
  expect(
    ToRawFixed(new Decimal('1234567891234567.35'), 0, 2, 2, 1, 'half-infinity')
  ).toEqual({
